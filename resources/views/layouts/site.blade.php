            ...
            <div class="container topbar bg-primary d-none d-lg-block">
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#" class="text-white">182 Tăng Nhơn Phú, Phước Long A, Thủ Đức</a></small>
                        <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#" class="text-white">Khanh@gmail.com</a></small>
                    </div>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            <a href="http://localhost/HuynhDuyKhanh_CD1/public/" class="nav-item nav-link active">Trang chủ</a>
                            <a href="http://localhost/HuynhDuyKhanh_CD1/public/product" class="nav-item nav-link">Cửa hàng</a>
                            <a href="http://localhost/HuynhDuyKhanh_CD1/public/product_detail/{slug}" class="nav-item nav-link">Chi tiết cửa hàng</a>
                            ...
                            <a href="http://localhost/HuynhDuyKhanh_CD1/public/contact" class="nav-item nav-link">Liên hệ</a>
                        </div>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <h1 class="mb-5 display-3 text-primary">Rau và trái cây</h1>
                    </div>
                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="carousel-item rounded">
                                    ...
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Rau</a>
                                </div>
                            </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Địa chỉ: 182 Tăng Nhơn Phú, Phước Long A, Thủ Đức</p>
                            <p>Email: khanh@gmail.com</p>
